        ...
        <div x-data="{ show: false }" class="mt-4">
          ...
          <div class="flex items-center">
            <input
              ...
              required
              placeholder="••••••••"
              class="block w-full px-4 py-3 rounded-lg border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500"
            />
            <button
              type="button"
              @click="show = !show"
              class="ml-3 text-gray-500 hover:text-green-600"
