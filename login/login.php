    ...
    <div class="bg-white rounded-3xl shadow-2xl p-10 w-full max-w-md">
     <?php
      ...
      <form method="POST" action="logincode.php" class="space-y-6">
        ...
        <!-- Forgot Password Link - Updated with better styling and positioning -->
        <div class="text-right">
          <a href="forgot_password.php" class="text-sm text-blue-500 hover:text-blue-700 hover:underline">
